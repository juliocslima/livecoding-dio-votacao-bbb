...
public class SwaggerConfiguration {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("me.dio.votacao.bbb.api.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                ...
                "Esta API é utilizada no curso LivingCode da DIO",
                "Versão 1.0.0",
                "",
                new Contact("Julio Lima", "https://github.com/juliocslima", "juliocslima@gmail.com"),
                "Permitido para usos acadêmicos",
                "",
